...
class EndorserClient {
    ...
    /**
     * Rongzer,王剑，发送Peer过桥交易
     * @param rbcMessage
     * @return
     * @throws PeerException
     */
    public FabricProposalResponse.ProposalResponse sendExecTransaction(RBCMessage rbcMessage) throws PeerException {
        if (shutdown) {
            throw new PeerException("Shutdown");
        }
		FabricProposalResponse.ProposalResponse response = blockingStub.sendTransaction(rbcMessage);
