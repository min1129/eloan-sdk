...
public class TransactionRequest {
    ...
    //rongzer,王剑增 加
    protected String chaincodeSpecDesc = "";
    public String getChaincodeSpecDesc() {
		return chaincodeSpecDesc;
	}

	public void setChaincodeSpecDesc(String chaincodeSpecDesc) {
		this.chaincodeSpecDesc = chaincodeSpecDesc;
	}
