...
public class RBCIESEngine 
{
    ...
    {
    	byte[] inAdd =  new byte[inLen+16];
    	
    	 System.arraycopy(in, 0, inAdd,16, inLen);
    	 in =inAdd;
    	 inLen = inLen +16;
        ...
        {
            // Block cipher mode.
            K1 = new byte[((IESWithCipherParameters)param).getCipherKeySize()*2 / 8];
            K2 = new byte[param.getMacKeySize()*2 / 8];
            K = new byte[K1.length + K2.length];
        ...
        throws InvalidCipherTextException
    {
        ...
        String sK2 = ByteUtils.toHexString(K2);
        ...
        // Output the message.
        return Arrays.copyOfRange(M, 16, len);
    }
...
*/
        ...
        {
            // Initialise the KDF.
            HKDFParameters kdfParam = new HKDFParameters(Z,new byte[0],null);
            kdf.init(kdfParam);
